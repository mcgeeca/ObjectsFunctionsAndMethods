...
#            associated with this RoseWindow, then draws all those
#            shapes.  After doing so, pauses the given number of seconds.,
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            It's put after each function to transition from page to page of
#            the program.
#
